...
### Problem <a href="#toc--problem-0" id="toc--problem-0"></a>
...
![1 / 2 • Indoor Environment 1](https://hackster.imgix.net/uploads/attachments/1435381/2015-05-12t12-41-16\_846z\_Ih0xnJgU2o.jpg?auto=compress%2Cformat\&w=740\&h=555\&fit=max)
...
![Automatically label data using the labelling queue feature](https://hackster.imgix.net/uploads/attachments/1435392/image\_FYTFzkdzpA.png?auto=compress%2Cformat\&w=740\&h=555\&fit=max)
...
![1 / 2 • Training Statistics](https://hackster.imgix.net/uploads/attachments/1436707/image\_TkXyrQFooZ.png?auto=compress%2Cformat\&w=740\&h=555\&fit=max)
...
This section describes how this system works.

![System overview](https://hackster.imgix.net/uploads/attachments/1439408/image\_IysCnHHdsi.png?auto=compress%2Cformat\&w=740\&h=555\&fit=max)

The working of this system is quite simple. The Vision shield (or any camera) captures a 240x240 image of the environment and passes it to the FOMO model prepared using Edge Impulse. This model then identifies the people in the image and passes the number of people to the CO2 level estimation function every minute. The function then estimates the amount of CO2 using the below formula.
...
### Demo <a href="#toc---demo-5" id="toc---demo-5"></a>
